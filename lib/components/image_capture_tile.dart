...
///
class ImageCaptureTile extends StatefulWidget {
  final String question;
  final String documentID;
  final String imageUrl;

  //remember to access these immutable variables in our state object we use widget.hint etc
  ImageCaptureTile({@required this.question, this.documentID, this.imageUrl});
...
class _ImageCaptureTile extends State<ImageCaptureTile>
